...
INSERT INTO `rol`( `descripcion`, `estado`, `nombre_del_rol`) VALUES ('Usuario Administrador que accede a lo mas intimo del sistema',1,'Administrador');

INSERT INTO `rol`( `descripcion`, `estado`, `nombre_del_rol`) VALUES ('Usuario Empleador que accede a lo mas facil del sistema',2,'Empleado');
